    ...
    initialMessages: [
      {
        id: 'welcome',
        role: 'assistant',
        content: "Hello! I'm here to listen and support you in a safe, non-judgmental space. How are you feeling today?",
      },
    ],
    body: {
      apiKey: apiKey,
    ...
    <div className="flex flex-col h-[calc(100vh-8rem)] bg-background">
      ...
      <form onSubmit={handleFormSubmit} className="p-4 border-t">
        <div className="flex gap-2">
          <Textarea
            ...
            placeholder={apiKey ? "Share what's on your mind..." : "Please add your OpenAI API key in settings to start chatting"}
      ...
      <div className="p-4 text-center text-sm text-muted-foreground border-t">
        <p className="font-semibold mb-1">
          If you&apos;re experiencing a crisis, please contact your local emergency services or mental health crisis hotline.
        </p>
        <p>
          This AI chatbot is not a substitute for professional mental health care.
        </p>
      </div>
    </div>
  );
